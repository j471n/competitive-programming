...
void solve() {
  ...
  int firstOfferEvaluation = (firstOffer * 100) / 10;
  int secondOfferEvaluation = (secondOffer * 100) / 20;

  if (firstOfferEvaluation == secondOfferEvaluation) {
    write("ANY");
  } else if (firstOfferEvaluation > secondOfferEvaluation) {
    write("FIRST");
  } else {
    write("SECOND");
  }
