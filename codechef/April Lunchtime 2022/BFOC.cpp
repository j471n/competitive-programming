 ...
 * Language : C++
 * Problem Name : Buckets Full of Candies
...
void solve() {
  // Taking Input
  readll(n); // n - Number of friends
  readll(m); // m - Number of candies that you have
  readll(l); // l - Number of buckets with the 1st friend respectively.
