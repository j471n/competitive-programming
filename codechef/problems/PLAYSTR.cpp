...
void solve() {
  ...
  int zeroInStringOne = countof(s1, '0');
  int zeroInStringTwo = countof(s2, '0');
  int onesInStringOne = countof(s1, '1');
  int onesInStringTwo = countof(s2, '1');

  (zeroInStringOne == zeroInStringTwo and onesInStringOne == onesInStringTwo)
      ? write("YES")
      : write("NO");
}
